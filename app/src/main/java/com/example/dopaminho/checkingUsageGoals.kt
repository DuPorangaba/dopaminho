...
suspend fun checkStatsGoals(context: Context) {
    ...
    var savedGoals = goalRepository.loadGoals()
    ...
    for (goal in savedGoals) {
        ...
        if (app != null) {
            ...
            if(appTimeUsage >= appTimeGoal * 3 && BarraDeVida.vidaAtual > 30 && goal.notification == 1)  {
                BarraDeVida.perdeVida(20)
                goal.notification = 0
            ...
            if (appTimeUsage >= appTimeGoal * 2 && BarraDeVida.vidaAtual > 50 && goal.notification == 2)  {
                BarraDeVida.perdeVida(20)
                goal.notification = 1
                notification.mostrarNotificacao(
            ...
            if (appTimeUsage > appTimeGoal  && goal.notification == 3 && BarraDeVida.vidaAtual > 70.0)  {
                BarraDeVida.perdeVida(30)
                goal.notification = 2
                notification.mostrarNotificacao(
